            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                HStack(alignment: .center) {
                    VStack(alignment: .leading, spacing: 5) {
                        ...
                        Text("디스크 크기 및 바이너리 해시 비교를 기반으로 완벽히 일치하는 복제 파일을 스캔하여 안전하게 정리합니다.")
                            .font(.subheadline)
                        ...
                        ScrollView(.vertical, showsIndicators: true) {
                            VStack(spacing: 16) {
                                ForEach(viewModel.groups.indices, id: \.self) { groupIndex in
                                                ...
                                                HStack {
                                                    Button(action: {
                                                        ...
                                                        Image(systemName: inst.isSelected ? "checkmark.square.fill" : "square")
                                                            .foregroundColor(inst.isSelected ? .green : .secondary)
                                                    }
                                                    .buttonStyle(.plain)
                                    ...
                                    .padding(12)
                                    .background(RoundedRectangle(cornerRadius: 12).fill(Color(NSColor.controlBackgroundColor).opacity(0.3)))
