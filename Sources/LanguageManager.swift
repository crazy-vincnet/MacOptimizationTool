...
class LanguageManager: ObservableObject {
    ...
    private let translations: [AppLanguage: [String: String]] = [
        ...
        .english: [
            ...
            "settings.subtitle": "Configure background tasks, macOS permissions, scanning rules, and more.",
            "settings.permissions": "macOS System Permissions",
            "settings.fda": "Full Disk Access (FDA)",
            "settings.fdaDesc": "Required for cache cleaning and large/duplicate file scanners to scan your drive securely and completely.",
            "settings.notifications": "Notification Permission",
            "settings.notificationsDesc": "Receive system banners when memory optimization or disk cleanups are completed.",
            "settings.sysSettings": "Open Settings",
            "settings.reqPerm": "Request Permission",
            "settings.refresh": "Refresh Status",
            "settings.autoOpt": "Auto-Optimization & Notifications",
            "settings.autoMem": "Auto Purge on Low Memory",
            "settings.autoMemDesc": "Purge system caches to reclaim memory when free RAM falls below the threshold.",
            "settings.memThresh": "Auto Purge Memory Threshold:",
            "settings.optNotif": "Show Optimization Notifications",
            "settings.optNotifDesc": "Notify via macOS banners when disk cleanup or automatic RAM recoveries occur.",
            "settings.scanSettings": "Disk Scan Settings",
            "settings.defaultPath": "Default Scan Path",
            "settings.defaultPathDesc": "The initial directory targeted by the large file explorer and duplicate file finder.",
            "settings.selectPath": "Choose...",
            "settings.langSettings": "Language Settings",
            "settings.langSelect": "Primary Language",
            "settings.appStartup": "App Startup & Version Info",
            "settings.loginStart": "Launch at Login",
            "settings.loginStartDesc": "Automatically start Mac Clean Optimizer at login to enable background protections.",
            "settings.version": "Current Version",
            "settings.buildDate": "Build Date",
            "settings.checkUpdate": "Check Updates",
            "settings.updateAlert": "You are currently using the latest version (v1.0.0)."
        ],
        .chinese: [
            // Sidebar
            "menu.dashboard": "仪表板",
            "menu.uninstaller": "应用卸载器",
            "menu.diskCleaner": "磁盘清理",
            "menu.largeFiles": "大文件清理",
            "menu.duplicateFinder": "重复文件清理",
            "menu.startupManager": "启动项管理",
            "menu.winCompat": "Windows名称兼容",
            ...
            "settings.langSettings": "语言设置 (Language)",
