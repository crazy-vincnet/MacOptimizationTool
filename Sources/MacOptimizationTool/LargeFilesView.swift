            ...
            if viewModel.isScanning {
                ZStack {
                    ...
                    VStack(spacing: 18) {
                        ...
                        VStack(spacing: 4) {
                            Text(String(format: t("large.scan.currentPath"), viewModel.currentScanPath))
                                .font(.system(size: 11, design: .monospaced))
                                .foregroundColor(Theme.textSecondary)
                                .lineLimit(1)
                                .frame(maxWidth: 380)

                            Text(String(format: t("large.scan.progress"), viewModel.scannedCount, viewModel.matchedCount))
                                .font(.system(size: 11))
                                .foregroundColor(Theme.textSecondary)
                        }
